...
/**
 * Class to dispaly admin type users main menu
 *
 * @package    gradebook
...
class Dashboard extends CI_Controller 
{
    ...
    private function authenticate()
    {
        ...
        {
            // IF SESSION IS NOT ASSOCIATED WITH USER TYPE ADMIN AND USER IS NOT ACTIVATED REDIRECT TO GATEWAY
            if($this->session->userdata('userType') !== 'ADMIN' || $this->session->userdata('status') !== 'ACTIVE')
            {
    ...
    public function index()
    {
        ...
        $data['cssArray'] = array('style.css','Admin_dashboard.css');
        $data['jsArray'] = array();
